    ...
    body={
      <div>
        ...
        <Row className="text-center">
          <Col className="py-5">
            <Button size="lg" color="secondary" className="mx-3"><a href="/force-outcome" className="text-white">&lt; Previous: Force by outcome</a></Button>
            <Button size="lg" color="success"><a href="/force-most" className="text-white">Next: Officers using most force ></a></Button>
          </Col>
        </Row>
      </div>
    }
...
export default ForceJustificationPage
